...
```{r data}
counts <- read.csv("~/git_repos/HUTI-RNAseq/analysis/get-homologs/2017-01-30-htseq-counts/core_counts_uti.csv", header = TRUE, row.names = 1)
experiment_info <- read.csv("~/git_repos/HUTI-RNAseq/analysis/get-homologs/counts/uti_info.csv", header = TRUE, row.names =1)
head(counts, 1)
