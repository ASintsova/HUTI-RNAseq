...
```{r data}
counts <- read.csv("~/git_repos/HUTI-RNAseq/analysis/get-homologs/2017-01-30-htseq-counts/core_gene_counts.csv", header = TRUE, row.names = 1)
...
plotPCA(dds_transformed, intgroup = c("MEDIA"))
