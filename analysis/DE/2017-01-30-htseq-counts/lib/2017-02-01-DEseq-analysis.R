...
write.csv(core_genes, "~/git_repos/HUTI-RNAseq/analysis/get-homologs/2017-01-30-htseq-counts/core_gene_counts.csv", row.names=TRUE)
write.csv(core_urine, "~/git_repos/HUTI-RNAseq/analysis/get-homologs/2017-01-30-htseq-counts/core_counts_urine.csv", row.names=TRUE)
write.csv(core_uti, "~/git_repos/HUTI-RNAseq/analysis/get-homologs/2017-01-30-htseq-counts/core_counts_uti.csv", row.names=TRUE)
write.csv(urine_info, "~/git_repos/HUTI-RNAseq/analysis/get-homologs/2017-01-30-htseq-counts/urine_info.csv", row.names=TRUE)
write.csv(uti_info, "~/git_repos/HUTI-RNAseq/analysis/get-homologs/2017-01-30-htseq-counts/uti_info.csv", row.names=TRUE)
...
pcaData <- plotPCA(core_dds_transformed, intgroup = c("STRAIN", "MEDIA"), returnData = TRUE)
percentVar <- round(100*attr(pcaData, "percentVar"))

ggplot(data = pcaData, aes(x=PC1, y=PC2, color = STRAIN , shape =MEDIA)) + 
